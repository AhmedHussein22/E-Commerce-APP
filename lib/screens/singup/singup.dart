                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Image.asset("assets/img/singup&login/singup.png",
                            ...
                            Card(
                              ...
                              child: TextFormField(
                                ...
                                validator: (value) => value.length < 6
                                    ? "Pleas Enter Password more than 6 chart"
                                    : null,
                                onChanged: (value) {
                                  setState(() => pass = value);
                                },
                        ...
                        child: RaisedButton(
                          onPressed: () async {
                            if (_formKey.currentState.validate()) {
                              ...
                              dynamic result =
                                  await _auth.singUPWithMailAndPass(mail, pass);
                              if (result == null) {
                                 
                                setState(
                                  () {
                                    error="please enter vaild mail";
                                    isLoasing = false;
